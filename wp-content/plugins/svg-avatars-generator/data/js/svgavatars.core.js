...
window.jQuery(document).ready(function($) {
	...
	if (options.removeCredit) {
		authorCredit = '';
	} else {
		authorCredit = '<p class="svga-credit">' + translation.authoredMsg + '<a href="http://svgavatars.com" target="_blank" rel="nofollow">svgAvatars.com</a></p>';
	}
